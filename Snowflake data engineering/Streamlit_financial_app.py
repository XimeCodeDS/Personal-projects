...
# Streamlit app
st.title("Trends:Consumer Price Index and Annual Wages in the USA")

# Monthly CPI Data chart
st.subheader("Average monthly CPI, June 2021 through April 2024")
line = alt.Chart(monthly_cpi_data).mark_line(color='#27F5B7').encode(
...
annual_wages_line = base.mark_line(color='#27F5B7').encode(
