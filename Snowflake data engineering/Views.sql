...
SELECT * FROM test_database.test_schema.truck_franchise
...
CREATE MATERIALIZED VIEW tasty_bytes.harmonized.truck_franchise_materialized   -- can´t use join with materialized views
  AS
SELECT
    t.*,
    f.first_name AS franchisee_first_name,
