...
# Streamlit App
st.title(":bulb: Fictional dataset Streamlit App :chart_with_upwards_trend:")
st.write(
...
forward on their mission. This chart is just an example of the power of data cloud and streamlit to build ready-to-go apps
    """
)
st.divider()
...
@st.cache_data #functions to fecth data
...
def get_city_sales_chart(sales_data: pd.DataFrame):
    ...
    chart = (
        ...
        .mark_line(point=False, tooltip=True) # allows to hover over and see values
        .encode(
