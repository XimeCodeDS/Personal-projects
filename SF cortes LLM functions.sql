...
SELECT SNOWFLAKE.CORTEX.COMPLETE(
    'mistral-7b', -- the model used for the query, there are many available
    [
        {'role': 'system', 
    ...
    ], -- the array with the prompt history, and the new prompt
...
SELECT SNOWFLAKE.CORTEX.COMPLETE(
    ...
    [
        ...
        {'role': 'user',
        'content': 'Based on other information you know about Snowflake, explain why the reviewer might feel the way they do.'}
...
SELECT SNOWFLAKE.CORTEX.COMPLETE(
'mistral-7b', 
CONCAT('Decribe this food: ', menu_item_name)
